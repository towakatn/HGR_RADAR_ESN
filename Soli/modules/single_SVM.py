#!/usr/bin/env python3
"""
Single SVM: Single-Reservoir ESN with SVM
1つのリザバー（500ノード）でSVM (RBF kernel)分類
...
from .config import DATA_CONFIG, SINGLE_RESERVOIR_CONFIG, SVM_CONFIG
from .evaluation import run_full_evaluation


def get_model_params():
    """Single SVM用モデルパラメータを取得"""
    return {
        'classifier_type': 'svm',
