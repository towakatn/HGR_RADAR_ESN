#!/usr/bin/env python3
"""
Single Ridge: Single-Reservoir ESN with Ridge Classifier
1つのリザバー（500ノード）でRidge Classifier分類
...
from .config import DATA_CONFIG, SINGLE_RESERVOIR_CONFIG, RIDGE_CONFIG
from .evaluation import run_full_evaluation


def get_model_params():
    """Single Ridge用モデルパラメータを取得"""
    return {
        ...
        'classifier_config': RIDGE_CONFIG,
    }
